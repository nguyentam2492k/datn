class ConstantList {
  ...
  static List<String> admissionCodes = [
    ...
    "CN17 - Kỹ thuật RobotCN2 - Kỹ thuật Máy tính",
    "CN3 - Vật lý kỹ thuật",
    "CN4 - Cơ kỹ thuật",
  ...
  static List<String> studentTypes = [
    ...
    'Bố mẹ bị tai nạn lao động',
    'Mồ côi',
    'Dân tộc thiểu số',
    'Hộ nghèo/cận nghèo',
    'Đã từng làm bí thư đoàn',
    'Đã từng làm lớp trưởng',
    'Thuộc vùng đặc biệt khó khăn'
  ];

  static List<String> feeTypes = [
    'Không miễn giảm',
    'Giảm học phí',
    'Miễn học phí'
  ];
